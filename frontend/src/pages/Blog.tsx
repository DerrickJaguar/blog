      ...
      <div className="flex justify-center w-full pb-15 border-b-2 border-gray-100">
        <div className="flex flex-col h-full w-2xl items-start mt-40 ">
          <div className="flex justify-between items-start w-full">
            <div className="text-5xl font-bold flex-1">{blog.title}</div>
            {isAdmin && (
              <div className="flex gap-3 ml-4">
                <Link to={`/blogs/edit/${blog.id}`}>
                  <button className="flex items-center gap-2 px-4 py-2 text-blue-600 hover:bg-blue-50 border border-blue-600 rounded-lg transition-colors">
